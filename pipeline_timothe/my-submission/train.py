...
from CONFIG import MA_ENV_NAME, config, ConfigTest, CHECKPOINT_ROOT, NUM_ITERATIONS, CHECKPOINT_RESTORED_NAME
...
if __name__ == "__main__":
    ...
    if CHECKPOINT_RESTORED_NAME is not None:
        trainer.restore(CHECKPOINT_RESTORED_NAME)
