...
### TRAINER
class SimplePPOTrainer(ppo.PPOTrainer):
    pass

class SimpleDQNTrainer(dqn.DQNTrainer):
    pass


if False:       # for a more complex trainer (for later)
    ...
    class ComplexTrainer(ppo.PPOTrainer):
        
        
        @classmethod
        @override(PPOTrainer)
        def get_default_config(cls) -> TrainerConfigDict:
            return config_concerning_trainer
